...
.PHONY: test test-unit test-contract test-integration test-live test-e2e test-e2e-live test-ci test-debug-ingest
...
test-e2e:
	set -a; source .env; set +a; export DATABASE_URL=sqlite:///./app.db; cd frontend && npm run test:e2e
